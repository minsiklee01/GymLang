...
public class GymlangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMENT", "MULTILINE_COMMENT", "EQUAL", "OCB", "CCB", "OP", "CP", "DOT", 
			"COMMA", "COL", "DASH", "PLUS", "MUSCLE_GROUP", "GYM", "START_PROGRAM", 
			"END", "TPS", "DPW", "VOLUME", "REST", "SETS", "SET", "MIN", "USE", "DSET", 
			"ASET", "CHANGE", "TO", "WITH", "WEEK", "DAY", "DEFSET", "WEIGHT", "REPS", 
			"CLETTER", "LETTER", "NDIGIT", "DIGIT", "NAME", "NUMBER", "WS"
		};
	}
	...
	public GymlangLexer(CharStream input) {
		super(input);
